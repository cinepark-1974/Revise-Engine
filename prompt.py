...
[올바른 예시 (JSON 안에서)]
"revised_content": "S#26. INT. 강회장 사무실 — 일요일 오후\\n\\n넓은 사무실. 책상 위에 서류와 만년필.\\n\\n유진이 들어선다. 의자에 앉지 않는다.\\n\\n강회장\\t\\t앉아.\\n\\n유진\\t\\t서서 들을게요.\\n\\n강회장이 계약서를 손가락으로 민다.\\n\\n강회장\\t\\t6개월 뒤 임대료 30% 인상이야.\\n\\n유진이 계약서를 집어 든다."

[잘못된 예시 (절대 금지)]
"revised_content": "S#26. INT. 강회장 사무실 — 일요일 오후 넓은 사무실. 책상 위에 서류와 만년필. 유진이 들어선다. 강회장: 앉아. 유진: 서서 들을게요. 강회장이 계약서를 민다."
