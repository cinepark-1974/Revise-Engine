...
{{
  "revision_plan": {{
    ...
    "target_scenes": [
      {{
        "scene_id": "씬 번호 또는 씬 헤더 (예: S#35. INT. 카페 — DAY)",
...
14. type="ADD": 새 씬을 만든다.
    ...
    - scene_header는 (NEW) 표기 후 위치 명시 (예: "(NEW) S#42-1. INT. 진호의 회상 — NIGHT")
...
[한국 시나리오 포맷 규칙]
1. 씬 헤더: S#번호. INT./EXT. 장소 — DAY 또는 NIGHT (예: S#35. INT. 카페 — DAY)
   ※ 시간 표기는 반드시 DAY 또는 NIGHT 둘 중 하나만 사용한다.
   ※ 요일(월/화/수…), 디테일 시간(아침/오전/오후/저녁/밤/낮)은 절대 금지.
...
1. 씬 헤더는 한 줄 — 시간 표기는 반드시 DAY 또는 NIGHT
   ✅ 예: "S#26. INT. 강회장 사무실 — DAY"
   ✅ 예: "S#71. EXT. 반세웅 원룸 건물 앞 — NIGHT"
   ❌ 금지: "토요일 오후" / "일요일 저녁" / "월요일" / "이른 아침" / "낮" / "밤" / "야경" 등
   ※ 요일(월/화/수/목/금/토/일), 디테일 시간(아침/오전/오후/저녁/낮/밤/야경)은 절대 사용 금지.
   ※ 시간대 디테일이 연출 의도상 필요하면 DAY/NIGHT 뒤에 (D2)·(N1) 같은 슬레이트 표기로 별도 처리.
2. 씬 헤더 다음 빈 줄 하나 (\\n\\n)
3. 지문은 현재형, 한 단락이 한 문단
4. 대사는 캐릭터명\\t\\t대사 (탭 두 개)
...
[잘못된 예시 — 형식 (절대 금지)]
"revised_content": "S#26. INT. 강회장 사무실 — DAY 넓은 사무실. 책상 위에 서류와 만년필. 유진이 들어선다. 강회장: 앉아. 유진: 서서 들을게요. 강회장이 계약서를 민다."
↑ 줄바꿈 없음 + 콜론 사용 → DOCX 출력 시 모든 텍스트가 한 문단으로 묶여 시나리오 포맷 완전히 무너짐.

[잘못된 예시 — 시간 표기 (절대 금지)]
❌ "S#26. INT. 강회장 사무실 — 일요일 오후"  → 요일+디테일 이중 위반
❌ "S#10. EXT. 한남동 골목 — 토요일 저녁"   → 요일+디테일 이중 위반
❌ "S#37. INT. 강회장 사무실 — 일요일"      → 요일만 표기, DAY/NIGHT 부재
❌ "S#1. EXT. 한남시장 — 이른 아침"          → 디테일 시간 표기 (아침/낮/저녁/밤 모두 금지)
❌ "S#21. 식재료 상가 — 낮"                  → INT./EXT. 누락 + 디테일 시간 표기
✅ "S#26. INT. 강회장 사무실 — DAY"
✅ "S#10. EXT. 한남동 골목 — NIGHT"
✅ "S#37. INT. 강회장 사무실 — DAY"
✅ "S#1. EXT. 한남시장 — DAY"
✅ "S#21. INT. 식재료 상가 — DAY"
  ...
  "revision_result": {{
    ...
    "revised_scenes": [
      {{
        ...
        "scene_header": "수정된 씬 헤더 (예: S#35. INT. 카페 — DAY)",
